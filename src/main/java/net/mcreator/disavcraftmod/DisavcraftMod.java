 ...
 *
 */
package net.mcreator.disavcraftmod;
...
import net.mcreator.disavcraftmod.init.DisavcraftModParticleTypes;
...
@Mod("disavcraft")
public class DisavcraftMod {
	public static final Logger LOGGER = LogManager.getLogger(DisavcraftMod.class);
	public static final String MODID = "disavcraft";

	public DisavcraftMod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		DisavcraftModBlocks.REGISTRY.register(bus);

		DisavcraftModItems.REGISTRY.register(bus);
		...
		DisavcraftModParticleTypes.REGISTRY.register(bus);
