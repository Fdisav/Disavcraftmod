...
@Mod("disavcraftmod")
public class DisavcraftmodMod {
	public static final Logger LOGGER = LogManager.getLogger(DisavcraftmodMod.class);
	public static final String MODID = "disavcraftmod";

	public DisavcraftmodMod() {
